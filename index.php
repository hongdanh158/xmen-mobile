<?php include('header.php') ?>
	<div class="section" id="firstPage">
		...
		<a href="#secondPage" class="o-icon c-icon-scrolldown3">
        <div class="icon-scroll"></div><span>Xem video</span></a>
	</div>
				...
				<div class="video-wrapper-inner">
					...
					<ul class="video-list c-carousel-v has-scroll">
	                    ...
	                    <li data-link="https://storage.googleapis.com/xmenmedia/video/4acc7ca0-cf7f-4c2d-8bfb-a6b1ab400432.mp4" data-poster="http://x-men.com.vn/static/default/frontend/tmp/xmen_boss/images/boss/poster_video4.jpg" class="nv4">
	                        ...
	                        <div class="caption-vd">
	                            <h4>Hành trình chinh phục <span>'Ý tưởng trăm triệu'</span></h4>
	                            <h4 class="f-m">Hành trình chinh phục <span>'Ý tưởng trăm triệu'</span></h4>
	                        </div>
	                    </li>
	                    <li data-link="https://storage.googleapis.com/xmenmedia/video/0ba7640b-c965-474c-a736-5ccf9ea96272.mp4" data-poster="images/video/phong-cach-doanh-nhan.jpg" class="nv5">
	                        <div class="wp-img"><img src="images/video/phong-cach-doanh-nhan-thumbnail.jpg" alt="x-men" class="img-responsive"/></div>
	                        <div class="caption-vd">
	                            <h4>Phong cách doanh nhân</h4>
...
<script>
	...
	var video = videojs("video-default", {
		"poster": "images/video/poster_video1.jpg",
		"autoplay" : true
	});
...
<script>
				...
				afterLoad: function(anchorLink, index) {
					...
					if (index == 2) {
						setInterval(function(){
							var vid = document.getElementById('vid1');vid.play();
						}, 1000);
						$(".s-section-slide").removeClass('active');
	...
	$('.video-list li').click(function () {
		...
		var name = $(this).find('h4').eq(0).html();
		var srcPoster = poster;
		$(".vjs-poster").attr('style', 'background-image:url(' + srcPoster + ')');
		var src = id;
		$('.video-wrapper-inner .video .name').html(name);
