		...
		<div class="left shampoo shampoo-180">
			...
			<div class="image">
				<video id="video-product" class="video-product" loop>
          			<source src="images/products/intense/dau-goi-180g.mp4" type="video/mp4">
        		</video>
				<img src="images/products/intense/dau-goi-180g.jpg" alt="">
			</div>
		</div>
		<div class="right">
			<h3 class="name">Dầu gội <br> X-MEN FOR BOSS INTENSE</h3>
			<div class="text">
				<p>Kết hợp gỗ Đàn Hương và Hổ Phách là cách tạo nên nốt hương trầm đầy nội lực của Intense - Mùi hương là sự đại diện cho một phong thái chắc chắn, một dấu ấn đậm nét của người đàn ông thành công, luôn quyết đoán và kiên định với mục tiêu của mình.</p>
			</div>
