		...
		<div class="left soap">
			...
			<div class="image">
				<video id="video-product" class="video-product" loop>
          			<source src="images/products/intense/xa-bong-cuc.mp4" type="video/mp4">
        		</video>
				<img src="images/products/intense/xa-bong-cuc.jpg" alt="">
			</div>
		</div>
		<div class="right">
			<h3 class="name">Xà bông cục<br> X-MEN FOR BOSS INTENSE</h3>
			<div class="text">
