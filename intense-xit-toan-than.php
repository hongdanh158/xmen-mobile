		...
		<div class="left spray">
			...
			<div class="image">
				<video id="video-product" class="video-product" loop>
          			<source src="images/products/intense/xit-toan-than.mp4" type="video/mp4">
        		</video>
				<img src="images/products/intense/xit-toan-than.jpg" alt="">
			</div>
		</div>
		<div class="right">
			<h3 class="name">Xịt toàn thân <br> X-MEN FOR BOSS INTENSE</h3>
			<div class="text">
				...
				<p>Đặc biệt với sự kết hợp thành phần cao cấp gỗ Đàn Hương và Hổ Phách tạo nên hương nước hoa trầm đầy nội lực dành cho người đàn ông thành công, luôn quyết đoán, kiên định.</p>
			</div>
			...
			<div class="slider-product-group">
				<div class="slider">
					...
					<div class="item">
						...
						<a href="intense-gel-tao-kieu.php" class="text-link">Gel Vuốt Tóc <br> X-Men For Boss Clean Cut</a>
					</div>
				</div>
			</div>
		</div>
