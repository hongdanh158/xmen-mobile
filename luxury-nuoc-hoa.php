<?php include('header.php') ?>
	<div class="products luxury" canvas="container">
		<div class="left perfume">
			<div class="sign">
				<p>"Được điều chế từ nhà điều hương  Christian Provenzano."</p>
				<img src="images/luxury/sign.png" alt="">
			</div>
			<div class="image">
				<video id="video-product" class="video-product" loop>
          			<source src="images/products/luxury/nuoc-hoa.mp4" type="video/mp4">
        		</video>
				<img src="images/products/luxury/nuoc-hoa.jpg" alt="">
			</div>
		</div>
		<div class="right">
			<h3 class="name">Nước hoa<br> X-MEN FOR BOSS Luxury</h3>
			<div class="text">
				<p>Sự tươi mát lấy cảm hứng từ Bergamot miền Nam nước Ý kết hợp cùng nốt hương trầm đầy sang trọng từ Đàn Hương - hương nước hoa Luxury như một biểu tượng của sự tinh tế, dành riêng cho người đàn ông sang trọng, đẳng cấp, luôn biết tận hưởng hương vị của thành công!</p>
			</div>
