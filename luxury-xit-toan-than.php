		...
		<div class="left spray">
			...
			<div class="image">
				<video id="video-product" class="video-product" loop>
          			<source src="images/products/luxury/xit-khu-mui.mp4" type="video/mp4">
        		</video>
				<img src="images/products/luxury/xit-khu-mui.jpg" alt="">
			</div>
		</div>
		<div class="right">
			<h3 class="name">Xịt toàn thân<br> X-MEN FOR BOSS Luxury</h3>
			<div class="text">
