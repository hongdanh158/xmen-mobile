		...
		<div class="left shower shower-180">
			...
			<div class="image">
				<video id="video-product" class="video-product" loop>
          			<source src="images/products/motion/sua-tam-180g.mp4" type="video/mp4">
        		</video>
				<img src="images/products/motion/sua-tam-180g.jpg" alt="">
			</div>
		</div>
		<div class="right">
			<h3 class="name">SỮA TẮM <br> X-MEN FOR BOSS MOTION</h3>
			<div class="text">
				<p>Công thức chuyên biệt dành cho nam giới giúp làm sạch dầu nhờn và bụi bẩn trên cơ thể.</p>
			...
			<div class="slider-product-group">
				<div class="slider">
					<div class="item">
                        ...
                        <a href="motion-sua-tam-nuoc-hoa.php" class="text-link">Sữa tắm <br> X-men For Boss Motion <br> 650g</a>
                    </div>
					<div class="item">
